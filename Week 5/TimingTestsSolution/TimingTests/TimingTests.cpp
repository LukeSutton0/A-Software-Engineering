...
#include "../../../Dict-BinaryTree/Dictionary/dictionary.h"
#include "../../../Dict-BinaryTree/Dictionary/dictionary.cpp"
 ...
 */
nanoseconds timingTest_dict(unsigned long long int mapSize, unsigned long long int numberOfLookups)
{
...
int main()
{
    ...
    nanoseconds meanTimePerLookup = timingTest_dict(numberOfEntries, numberOfLookups);

    std::cout << "Dictionary being tested: myDict" << std::endl;
...
int main()
{
    // This is the parameter we're measuring against.
    // We're interested in how time performance scales against the number of entries in the dictionary.
    const unsigned long long int numberOfEntries = 50000000;
