...
#include <string>
#include "../Binary Tree Traversal/binaryTreeDict.h"

////////////////////////////////////////////////////////////////////////////////

// Utility Functions

void isPresent(BinaryTree& tree, int k, std::string i)
{
  std::string* p_i = tree.lookup(k);
...
void isAbsent(BinaryTree& tree, int k)
{
  BOOST_CHECK_MESSAGE(tree.printPathToNode(k) == nullptr,
